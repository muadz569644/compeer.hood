...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="dashboard.php">Compeer.hood</a></h1>
			<ul>
	...
	<div class="section">
		<div class="container">
			<footer>Data Produk</footer>
			<div class="box">
				<p><a href="tambah-produk.php" class="btn" style="margin-top: -10px; display: inline-block;" >Tambah Data</a></p>
